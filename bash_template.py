...
# Configuration generated by the Tkinter Bash Execution Generator.
# -----------------------------------------------------------------
...
LOG_FILE="/home/vboxuser/Desktop/Systems_Programming_Project/logging_file/{TIMESTAMP}.txt"

# --- Main Retry Logic ---

echo "Starting execution at $(date) (PID: $$)" > $LOG_FILE
...
for ((i=1; i<=MAX_TRIES; i++)); do
    ...
    if $COMMAND_TO_RUN >> $LOG_FILE 2>&1; then
        ...
        echo "Execution finished successfully at $(date)." | tee -a $LOG_FILE
